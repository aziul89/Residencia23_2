...
class CalcCategory extends StatelessWidget {
  @override
...
class CalcadosScreen extends StatelessWidget {
    final List<String> items = ["Tênis Adidas", "Sandália Crocs", "Chinelo Havaianas", "Plataforma Melissa", "Tênis Vans"];
