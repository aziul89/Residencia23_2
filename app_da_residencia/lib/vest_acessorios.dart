...
void main() {
  runApp(AcessoCategory());
}

class AcessoCategory extends StatelessWidget {
  @override
...
class AcessoScreen extends StatelessWidget {
  final List<String> items = ["Óculos Chilli Beans", "Boné Puma", "Bolsa Santa Lolla", "Bolsa Regressa", "Pulseira Pandora"];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Vestuário > Acessórios',
